				...
				<div class="card-body">
					<div class="gx-3 mb-3 row">
						...
						<div class="col-md-8 col-lg-9">
							<input class="form-control" disabled="disabled" id="id" type="text" value="<?= html_escape($transaction['id']) ?>" />
						</div>
					</div>
					<div class="gx-3 mb-3 row">
					...
					<div class="gx-3 mb-3 row">
						...
						<div class="col-md-8 col-lg-9">
							<input autofocus="autofocus" class="form-control <?= form_error('date') === '' ? '' : 'is-invalid' ?>" id="date" name="date" type="date" value="<?= html_escape(set_value('date', $transaction['date'])) ?>" />
					...
					<div class="gx-3 mb-3 row">
						...
						<div class="col-md-8 col-lg-9">
							<div class="has-validation input-group">
								...
								<input class="form-control <?= form_error('deposit') === '' ? '' : 'is-invalid' ?>" id="deposit" inputmode="numeric" name="deposit" oninput="currencyFormat();" type="text" value="<?= html_escape(set_value('deposit', number_format($transaction['deposit'], 0, ',', '.'))) ?>" />
					...
					<div class="gx-3 row">
						...
						<div class="col-md-8 col-lg-9">
							<div class="has-validation input-group">
								<span class="input-group-text">Rp</span>
								<input class="form-control <?= form_error('withdraw') === '' ? '' : 'is-invalid' ?>" id="withdraw" inputmode="numeric" name="withdraw" oninput="currencyFormat();" type="text" value="<?= html_escape(set_value('withdraw', number_format($transaction['withdraw'], 0, ',', '.'))) ?>" />
