			...
			?>
				...
				<div class="card-body">
					...
					<div class="gx-3 mb-3 row">
						...
						<div class="col-md-8 col-lg-9">
							<input class="form-control <?= form_error('tel') === '' ? '' : 'is-invalid' ?>" id="tel" name="tel" oninput="telFormat();" placeholder="Masukkan nomor telepon" type="tel" value="<?= html_escape(set_value('tel')) ?>" />
