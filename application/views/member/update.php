			...
			?>
				...
				<div class="card-body">
					...
					<div class="gx-3 mb-3 row">
						...
						<div class="col-md-8 col-lg-9">
							<input autofocus="autofocus" class="form-control <?= form_error('name') === '' ? '' : 'is-invalid' ?>" id="name" name="name" placeholder="Masukkan nama anggota" type="text" value="<?= html_escape(set_value('name', $member['name'])) ?>" />
					...
					<fieldset class="gx-3 mb-3 row">
						...
						<div class="col-md-8 col-lg-9">
							<div class="form-check form-check-inline">
								<input class="form-check-input <?= form_error('gender') === '' ? '' : 'is-invalid' ?>" <?= set_radio('gender', 'Laki-laki', $member['gender'] === 'Laki-laki') ?> id="male" name="gender" type="radio" value="Laki-laki" />
								<label class="form-check-label" for="male">Laki-laki</label>
							</div>
							<div class="form-check form-check-inline">
								<input class="form-check-input <?= form_error('gender') === '' ? '' : 'is-invalid' ?>" <?= set_radio('gender', 'Perempuan', $member['gender'] === 'Perempuan') ?> id="female" name="gender" type="radio" value="Perempuan" />
